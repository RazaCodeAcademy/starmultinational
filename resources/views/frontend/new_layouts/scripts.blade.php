<!-- BEGIN VENDOR JS-->
  ...
  <script src="{{asset('public/assets/frontend/js/toastr.min.js')}}"></script>
  <script src="{{ asset('public/app-assets/vendors/js/extensions/jquery.steps.min.js')}}" type="text/javascript"></script>
  <script src="{{ asset('public/app-assets/js/scripts/forms/wizard-steps.js')}}" type="text/javascript"></script>
  <script src="{{ asset('public/app-assets/js/scripts/customizer.js')}}" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
