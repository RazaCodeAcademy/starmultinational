            ...
            <div class="container">
                <div class="card card-custom">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('Update Account Types') }}</h3>
                    ...
                    <form method="POST" action="{{ route('manage-account-types.update', $account_type->id) }}" enctype="multipart/form-data">
                        @csrf
						@method('PUT')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Enter Account Type Name" value="{{ $account_type->name }}" required>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Account Price"
                                            name="price" value="{{ $account_type->price }}" required />
                                        @error('Price')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Left Users"
                                            name="left_users" value="{{ $account_type->left_users }}" required />
                                        @error('left_users')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Right Users"
                                            name="right_users" value="{{ $account_type->right_users }}" required />
                                        @error('right_users')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </span>
